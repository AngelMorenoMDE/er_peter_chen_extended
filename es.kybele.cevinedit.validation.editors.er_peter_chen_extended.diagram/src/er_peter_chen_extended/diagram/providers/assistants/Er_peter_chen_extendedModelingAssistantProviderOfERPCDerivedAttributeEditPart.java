 ...
 * @generated
 */
public class Er_peter_chen_extendedModelingAssistantProviderOfERPCDerivedAttributeEditPart
		extends
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		...
		return doGetRelTypesOnTarget((er_peter_chen_extended.diagram.edit.parts.ERPCDerivedAttributeEditPart) targetEditPart);
	}
	...
	public List<IElementType> doGetRelTypesOnTarget(
			er_peter_chen_extended.diagram.edit.parts.ERPCDerivedAttributeEditPart target) {
	...
	public List<IElementType> getTypesForSource(IAdaptable target,
		...
		return doGetTypesForSource(
				(er_peter_chen_extended.diagram.edit.parts.ERPCDerivedAttributeEditPart) targetEditPart,
				relationshipType);
	}
