 ...
 * @generated
 */
public class Er_peter_chen_extendedDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public Er_peter_chen_extendedDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof er_peter_chen_extended.diagram.navigator.Er_peter_chen_extendedDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((er_peter_chen_extended.diagram.navigator.Er_peter_chen_extendedDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new er_peter_chen_extended.diagram.navigator.Er_peter_chen_extendedDomainNavigatorItem(
