...
public class ERPCIdentifyingRelationshipEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen_extended.diagram.edit.policies.ERPCIdentifyingRelationshipItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof er_peter_chen_extended.diagram.edit.parts.ERPCIdentifyingRelationshipNameEditPart) {
			((er_peter_chen_extended.diagram.edit.parts.ERPCIdentifyingRelationshipNameEditPart) childEditPart)
	...
	public class ERPCIdentifyingRelationshipFigure extends ScalablePolygonShape {
		...
		private void createContents() {
			...
			eRPCIdentifyingRelationshipPolygonInternal0
					.setForegroundColor(ERPCIDENTIFYINGRELATIONSHIPPOLYGONINTERNAL0_FORE);
			eRPCIdentifyingRelationshipPolygonInternal0
					.setBackgroundColor(ERPCIDENTIFYINGRELATIONSHIPPOLYGONINTERNAL0_BACK);
			eRPCIdentifyingRelationshipPolygonInternal0
	 ...
	 * @generated
	 */
	static final Color THIS_FORE = new Color(null, 125, 132, 187);

	/**
	 * @generated
	 */
	static final Color THIS_BACK = new Color(null, 164, 169, 204);

	/**
	 * @generated
	 */
	static final Color ERPCIDENTIFYINGRELATIONSHIPPOLYGONINTERNAL0_FORE = new Color(
			null, 125, 132, 187);

	/**
	 * @generated
	 */
	static final Color ERPCIDENTIFYINGRELATIONSHIPPOLYGONINTERNAL0_BACK = new Color(
			null, 164, 169, 204);
