...
public class ERPCPrimaryKeyAttributeNameEditPart extends CompartmentEditPart
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(
				...
				new er_peter_chen_extended.diagram.edit.policies.Er_peter_chen_extendedTextSelectionEditPolicy());
	...
	public IParser getParser() {
		if (parser == null) {
			parser = er_peter_chen_extended.diagram.providers.Er_peter_chen_extendedParserProvider
					.getParser(
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(
					this,
					null,
					er_peter_chen_extended.diagram.edit.parts.Er_peter_chen_extendedEditPartFactory
