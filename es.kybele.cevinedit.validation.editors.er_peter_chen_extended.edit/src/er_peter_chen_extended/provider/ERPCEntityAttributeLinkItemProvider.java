...
/**
 * This is the item provider adapter for a {@link er_peter_chen_extended.ERPCEntityAttributeLink} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Er_peter_chen_extendedPackage.Literals.ERPC_ENTITY_ATTRIBUTE_LINK__ENTITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 Er_peter_chen_extendedPackage.Literals.ERPC_ENTITY_ATTRIBUTE_LINK__ATTRIBUTE,
				 true,
				 false,
				 true,
				 null,
